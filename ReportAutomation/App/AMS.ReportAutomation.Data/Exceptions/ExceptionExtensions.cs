...
namespace AMS.ReportAutomation.Data.Exceptions
{
    public static class ExceptionExtensions
    {
        ...
        public static void Execute<TCatchedException, TWrapperException>(this object @this, IAMSLogger logger, Action action)
        ...
        /// <returns></returns>
        public static TResult Execute<TResult, TCatchedException, TWrapperException>(this object @this, IAMSLogger logger, Func<TResult> func)
            where TCatchedException : Exception
            where TWrapperException : Exception
        {
