...
SET nunitConsoleDir=%curDir%\NUnit_Console\NUnit.Console-3.10.0
...
start nunit3-console.exe nunit3-console --test=DynoMapper.SequentialRunningTestForAProject.sequentialRunningTestForAProject %dllDir%