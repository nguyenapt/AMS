namespace PingdomClient
{
    ...
    public sealed class Client : BaseClient
    {
        ...
        private TransactionChecksResource _transChecks;
        ...
        public TransactionChecksResource TransactionChecks
        {
            get
            {
                return _transChecks ?? (_transChecks = new TransactionChecksResource());
            }
        }
